...
![Picture of Documented UARTs]({{ site.url }}/assets/practical-reversing/znXRocn.jpg)
...
![boot msg kernel lzma]({{ site.url }}/assets/practical-reversing/9pRc2mP.jpg)

Intel on how the external flash memory is structured will be very useful when we
get to extracting it.

![ram data. not very useful]({{ site.url }}/assets/practical-reversing/OmDkAxX.jpg)

![SPI Flash Memory Map!]({{ site.url }}/assets/practical-reversing/ODnxzJY.jpg)

And more compression intel:

![root is squashfs'd]({{ site.url }}/assets/practical-reversing/Qw6Z08z.jpg)
...
![top]({{ site.url }}/assets/practical-reversing/d1lVlP4.png)
...
![Blurred /etc/serverkey.pem]({{ site.url }}/assets/practical-reversing/NNkvDdj.jpg)
...
![/var/wan/ppp256/config]({{ site.url }}/assets/practical-reversing/U86nGOp.png)
...
![Grep Password]({{ site.url }}/assets/practical-reversing/skmx7VE.jpg)
...
![WiFi pwd in curcfg.xml]({{ site.url }}/assets/practical-reversing/KCo2H4B.jpg)
...
![debug display cwmp]({{ site.url }}/assets/practical-reversing/2t6IfbQ.png)
...
![md `badd` Picture]({{ site.url }}/assets/practical-reversing/nKBcXmT.png)
...
![SPI Flash string in md]({{ site.url }}/assets/practical-reversing/aZ32bs8.png)
...
![md.w 0x000d0000]({{ site.url }}/assets/practical-reversing/SC1TaeF.png)
