...
![Flash Powered UART Connected]({{ site.url }}/assets/practical-reversing/JBTsUfo.png)
...
![Shikra and Power Connected to Flash]({{ site.url }}/assets/practical-reversing/SyUFtey.jpg)
...
![flashrom stdout]({{ site.url }}/assets/practical-reversing/VzvjX31.png)
...
![binwalk spidump.bin]({{ site.url }}/assets/practical-reversing/vdmjcDt.png)
...
![Flash Memory Map From Part 2]({{ site.url }}/assets/practical-reversing/CX9raje.png)
...
![binwalk bootloader.bin]({{ site.url }}/assets/practical-reversing/iuFJjvG.png)
...
![binwalk mainkernel.bin]({{ site.url }}/assets/practical-reversing/XrusrH2.png)
...
![dd if=mainkernel of=noheader]({{ site.url }}/assets/practical-reversing/ZY0CI10.png)
...
![Cut off the tail; decompression success]({{ site.url }}/assets/practical-reversing/4pdQnpX.png)
...
![strings kernel grep key]({{ site.url }}/assets/practical-reversing/nsWB75q.png)
...
![binwalk mainrootfs.bin]({{ site.url }}/assets/practical-reversing/v8E2WxQ.png)
...
![sqsh signature in hexdump]({{ site.url }}/assets/practical-reversing/GFaD38g.png)
...
![unsquashfs_all.sh mainrootfs.bin]({{ site.url }}/assets/practical-reversing/sYi6PO6.png)
...
![tree unsquashed_filesystem]({{ site.url }}/assets/practical-reversing/MUyII7j.png)
...
![grep -i -r '$INTEL' squashfs-root]({{ site.url }}/assets/practical-reversing/89GG8mJ.png)
...
![binwalk protect.bin]({{ site.url }}/assets/practical-reversing/t6bcd05.png)
...
![strings protect.bin]({{ site.url }}/assets/practical-reversing/bzPVpdy.png)
